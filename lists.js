...
const parseLists = (text) => {
  ...
  sections.forEach(section => {
    ...
    lines.forEach(line => {
      // Skip section headers (lines in CAPS)
      if (line.match(/^[A-Z\s\(\)]+$/)) {
        return;
      }
      ...
      // Add the line as an item (no numbers to remove)
...
const childsModeReplacements = {
  ...
  'wet t-shirt contest': 'cool t-shirt contest',
  'cunt': 'silly goose',
  'slutty vegan': 'vegan',
  ...
  'paralysis': 'meditation',
  'and a blunt': 'and a complimentary mint',
  'kill': 'unalive',
  'killed': 'unalived',
  ...
  'cocaine dog': 'dog',
  'YOUNG': 'BEST OF',
  'vial of dog pheromone': 'dog whistle',
  'my pacemaker explodes': 'my pacemaker beeps twice',
  'all rum': 'extra sugar',
  'spray dog pheromone': 'blow dog whistle'
